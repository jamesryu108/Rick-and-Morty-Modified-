...
func anchor(top: NSLayoutYAxisAnchor? = nil, verticalSpace: CGFloat? = nil, bottom: NSLayoutYAxisAnchor? = nil, left: NSLayoutXAxisAnchor? = nil, horizontalSpace: CGFloat? = nil, right: NSLayoutXAxisAnchor? = nil, width: CGFloat? = nil, height: CGFloat? = nil, centerX: NSLayoutXAxisAnchor? = nil, centerY: NSLayoutYAxisAnchor? = nil) {
