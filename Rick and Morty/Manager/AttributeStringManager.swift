...
class AttributeStringManager {
    ...
    static func outputAttributedString(text: String, episodeName: String) -> NSMutableAttributedString {
        ...
        let firstAttributes: [NSAttributedString.Key: Any] = [.font: UIFont.systemFont(ofSize: 20, weight: .bold), .foregroundColor: UIColor.black]
        
        let secondAttributes = [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 16, weight: .regular), .foregroundColor: UIColor.black]
